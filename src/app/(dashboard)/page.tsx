    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Common tasks to help you manage medication adherence</CardDescription>
        </CardHeader>
      ...
      <Card className="border-dashed">
        ...
        <CardContent className="text-muted-foreground space-y-2 text-sm">
          <p>This is the Ignite Health Command Center. Once configured, you&apos;ll see:</p>
