...
export default function SearchPlaygroundPage() {
  ...
  const searchUrl = medplum.fhirSearchUrl(search.resourceType, {
    ...Object.fromEntries(search.filters?.map(f => [f.code, f.value]) || []),
    _count: String(search.count || 20),
    _sort: search.sortRules?.map(s => (s.descending ? '-' : '') + s.code).join(',') || undefined,
  }).toString();
  ...
  return (
    <Stack gap="lg">
      ...
      <div>
        ...
        <Text c="dimmed">Learn FHIR search using Medplum's native SearchControl component</Text>
      </div>

      {/* Info Alert */}
      <Alert color="blue" variant="light" icon={<IconInfoCircle size={16} />}>
        <Text size="sm">
          <strong>Interactive Learning:</strong> Use the filters below to build FHIR queries.
          The SearchControl component handles all the complexity - filtering, sorting, pagination.
          Watch the generated URL to understand FHIR search syntax.
        </Text>
      </Alert>
          ...
          <Paper p="md" withBorder>
            <Stack gap="sm">
              <div>
                ...
                <Text size="sm" c="dimmed">This is the REST API call being made to Medplum</Text>
              </div>
          ...
          <Paper p="md" withBorder>
            <Stack gap="md">
              <div>
                ...
                <Text size="sm" c="dimmed">Use the toolbar to add filters, change columns, and sort results</Text>
              </div>
              <SearchControl
                search={search}
            ...
            <Paper p="md" withBorder>
              <Stack gap="sm">
                <div>
                  ...
                  <Text size="sm" c="dimmed">{selectedResource.resourceType}/{selectedResource.id}</Text>
                </div>
        ...
        <Stack gap="lg">
          <Paper p="md" withBorder>
            <Stack gap="sm">
              ...
              <Paper p="sm" withBorder bg="gray.0">
                <Text size="sm" fw={600}>Add Filters</Text>
                <Text size="xs" c="dimmed">Click the filter icon in the toolbar to add search conditions</Text>
              </Paper>
              <Paper p="sm" withBorder bg="gray.0">
                <Text size="sm" fw={600}>Sort Results</Text>
                <Text size="xs" c="dimmed">Click column headers to sort. Click again to reverse.</Text>
              </Paper>
              <Paper p="sm" withBorder bg="gray.0">
                <Text size="sm" fw={600}>Change Columns</Text>
                <Text size="xs" c="dimmed">Click the columns icon to show/hide fields</Text>
              </Paper>
              <Paper p="sm" withBorder bg="gray.0">
                <Text size="sm" fw={600}>Pagination</Text>
                <Text size="xs" c="dimmed">Use the arrows at the bottom to navigate pages</Text>
              </Paper>
            </Stack>
          </Paper>
          ...
          <Paper p="md" withBorder>
            <Stack gap="sm">
              ...
              <Paper p="sm" withBorder bg="gray.0">
                <Code>:contains</Code>
                <Text size="xs" c="dimmed">Partial text match</Text>
              </Paper>
              <Paper p="sm" withBorder bg="gray.0">
                <Code>:exact</Code>
                <Text size="xs" c="dimmed">Exact text match</Text>
              </Paper>
              <Paper p="sm" withBorder bg="gray.0">
                <Code>ge, le, gt, lt</Code>
                <Text size="xs" c="dimmed">Date/number comparisons</Text>
              </Paper>
              <Paper p="sm" withBorder bg="gray.0">
                <Code>:missing=true</Code>
                <Text size="xs" c="dimmed">Field is not set</Text>
              </Paper>
            </Stack>
          </Paper>
          ...
          <Paper p="md" withBorder>
            <Stack gap="xs">
              ...
              <Anchor
                href="https://hl7.org/fhir/R4/search.html"
                target="_blank"
                size="sm"
              >
              ...
              <Anchor
                href="https://docs.medplum.com/docs/search"
                target="_blank"
                size="sm"
              >
                <IconExternalLink size={14} style={{ marginRight: 4 }} />
